...
internal sealed class ApplicationVolumeService
{
    ...
    internal bool SetApplicationVolume(string processName, int volumePercent)
    {
        lock (_syncRoot)
        {
        ...
        string? sourceName)
    {
        ...
        {
            var snapshot = application.CreateSnapshot(sourceId, sourceName);
        ...
        string? sourceName)
    {
        ...
        return sessionDisplayName ?? MediaSessionService.GetDisplayName(processName);
    }
        ...
        string? sourceName)
    {
        ...
        var mappedProcessName = MediaSessionService.GetDisplayName(processName);
        return !string.IsNullOrWhiteSpace(sourceName) &&
