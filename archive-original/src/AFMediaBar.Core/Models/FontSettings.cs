...
public enum PlayerFontWeightPreset
{
    Light = 0,
    Standard = 1,
    Bold = 2
...
public readonly record struct FontSettings(
    ...
    int Weight)
{
    public const int MinWeight = 300;
    public const int MaxWeight = 900;
    public const int DefaultWeight = 600;
    ...
    public static int ResolveLegacyWeight(PlayerFontWeightPreset preset) =>
        preset switch
        {
    ...
    /// </summary>
    public static string ResolveText(LatinFontPreset latin, CjkFontPreset cjk)
    {
